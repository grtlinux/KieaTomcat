...
/**
 * tomcat6: can use InvokerServlet
 * tomcat7: use this InvokerLoadListener
 * 
    ...
    private Set<Class> checkClass(String name, Set<Class> classes) {
        ...
        try {
            ...
            */
            if (HttpServlet.class.isAssignableFrom(clazz)) {
                classes.add(clazz);
            } else if (ContainerServlet.class.isAssignableFrom(clazz)) {
                classes.add(clazz);
            }
        ...
        if (list != null) {
            ...
            for (int i = 0; i < packages.length; i++) {
                ...
                if (packageName.length() > 0) {
                    System.out.printf("Checking package: [%s]%n", packageName);
                    ...
                    for (Class clazz : classes) {
                        ...
                        */
                    	...
                    	String mapping = prefix + className;
