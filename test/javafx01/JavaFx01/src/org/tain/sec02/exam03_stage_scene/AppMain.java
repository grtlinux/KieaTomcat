package org.tain.sec02.exam03_stage_scene;
...
public class AppMain extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		root.setAlignment(Pos.CENTER);					//컨트롤을 중앙으로 정
		root.setSpacing(20);							//컨트롤을 수직 간격

		Label label = new Label();						//Label 컨트롤 생
		...
		Scene scene = new Scene(root);					//VBox를 루트 컨테이너로 해서 Scene 생
