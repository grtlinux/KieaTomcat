...
public class SpringBoot3JacksonJsonNodeApplication implements CommandLineRunner {

	private static final boolean flag = true;
	
	public static void main(String[] args) {
		SpringApplication.run(SpringBoot3JacksonJsonNodeApplication.class, args);
