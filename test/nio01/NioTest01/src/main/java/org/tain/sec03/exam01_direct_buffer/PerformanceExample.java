...
public class PerformanceExample {
	...
	public PerformanceExample() throws Exception {
		System.out.println(">>>>> " + ClassUtil.getClassInfo());

		Path from = Paths.get("src/main/java/org/tain/sec03/exam01_direct_buffer/house.jpg");
		Path to1 = Paths.get("src/main/java/org/tain/sec03/exam01_direct_buffer/house2.jpg");
		Path to2 = Paths.get("src/main/java/org/tain/sec03/exam01_direct_buffer/house3.jpg");
