...
public class ReqStreamToJson {
	...
	private ReqStreamToJson() throws Exception {
		if (flag) {
	...
	private static ReqStreamToJson instance = null;
	
	public synchronized static ReqStreamToJson getInstance() throws Exception {
		if (instance == null) {
			instance = new ReqStreamToJson();
		}
