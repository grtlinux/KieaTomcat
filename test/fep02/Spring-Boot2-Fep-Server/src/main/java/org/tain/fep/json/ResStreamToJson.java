...
//	private Item23Info item23Info = null;
	...
	private ResStreamToJson() throws Exception {
		if (flag) {
...
//		}
	...
	private static ResStreamToJson instance = null;
	
	public synchronized static ResStreamToJson getInstance() throws Exception {
		if (instance == null) {
			instance = new ResStreamToJson();
		}
